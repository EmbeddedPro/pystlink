...
class Stm32():
    ...
    def get_reg(self, reg):
        ...
        raise pystlink.stlinkex.StlinkException('Wrong register name')
    ...
    def fill_mem(self, addr, size, pattern):
        if pattern >= 256:
            raise pystlink.stlinkex.StlinkException('Fill pattern can by 8 bit number')
    ...
    def flash_erase_all(self):
        ...
        raise pystlink.stlinkex.StlinkException('Erasing FLASH is not implemented for this MCU')
    ...
    def flash_write(self, addr, data, erase=False, verify=False, erase_sizes=None):
        ...
        raise pystlink.stlinkex.StlinkException('Programing FLASH is not implemented for this MCU')
